...
FROM likes
WHERE project_id = $id
AND ((soiscatel_like_status = 0 AND project_like_status = 1)
OR (soiscatel_like_status = 1 AND project_like_status = 0))
AND EXISTS (
SELECT *
FROM likes AS l2
WHERE l2.soiscatel_id = likes.soiscatel_id AND l2.project_id = likes.project_id 
